...
```sh
git clone https://github.com/rohankumars01/Github-examples.git
cd GitHub-Examples
```
...
```ssh
git git@github.com:rohankumars01/Github-examples.git
cd GitHub-Examples
```
...
```sh
ssh-keygen -t ed25519 -C "kumarsrohan978@gmail.com"
...
```
gh auth login
gh repo clone rohankumars01/Github-examples
```
